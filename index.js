                        ...
                        .then(function(data) {
                            ...
                            if (text !== "") {
                                let timestampReg = new RegExp(
                                    /[F-W][a-u][d-u] [A-S][a-u][b-y] [0-3][0-9]. 202[1-9] [0-1][0-9]:[0-5][0-9]:[0-5][0-9]/i
                                );
                                let authorReg = new RegExp(
                                    /(?<=(<p class=leftbox><h3>)).*?(?=(<\/h3>))/
                                );
                                let commentReg = new RegExp(
